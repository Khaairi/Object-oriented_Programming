...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2132888", "Aceng", "A", 20, "Laki-Laki"));
        listMhs.add(new Mahasiswa("2132891", "Pahri", "A", 20, "Laki-Laki"));
        listMhs.add(new Mahasiswa("2132981", "Resyad", "A", 20, "Laki-Laki"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        Object[] column = {"NIM", "Nama", "Nilai", "Usia", "Jenis Kelamin"};
        ...
        for(int i = 0; i < listMhs.size(); i++){
            ...
            row[3] = listMhs.get(i).getUsia();
            row[4] = listMhs.get(i).getJKelamin();
    ...
    public void insertData() {
        ...
        int usia = (int)jUsia.getValue();
        String jKelamin;
        if(jRadioLaki.isSelected() == true)
        {
            jKelamin = jRadioLaki.getText();
        }
        else 
        {
            jKelamin = jRadioPerempuan.getText();
        }
        
        // Add New Data
        listMhs.add(new Mahasiswa(nim, nama, nilai, usia, jKelamin));
    ...
    public void updateData() {
        ...
        listMhs.get(selectedID).setJKelamin(jKelamin);
    ...
    private void initComponents() {
        ...
        jUsia = new javax.swing.JSpinner();
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jUsia, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jRadioLaki, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jRadioPerempuan, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnAdd)
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        int selectedUsia = (int)(tblMhs.getModel().getValueAt(row, 3));
        String selectedJKelamin = (tblMhs.getModel().getValueAt(row, 4).toString());
        ...
        jUsia.setValue(selectedUsia);
        if(selectedJKelamin == "Laki-Laki")
        {
    ...
    private void jUsiaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jUsiaStateChanged
        // TODO add your handling code here:
        
    }//GEN-LAST:event_jUsiaStateChanged
    ...
    private javax.swing.JSpinner jUsia;
